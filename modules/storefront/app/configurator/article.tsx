...
export default function Article({ article }: Props) {
  ...
  return (
    <div className="flex gap-4">
      <div className="min-h-full w-1/3 relative bg-white rounded-2xl overflow-hidden">
        <Image
      ...
      <ul className="flex-3 flex flex-col">
        <li>name: {article.name}</li>
        <li>PZN: {article.pzn}</li>
        <li>supplier: {article.supplier}</li>
        <li>price: {new Intl.NumberFormat("de-DE", {
          style: "currency",
          currency: "EUR",
        }).format(article.priceCents / 100)}</li>
        <li>
