...
export type StorageHash =
  StorageHashBase<'734b7f1183c5f4e551da8022a39843d19ca5c641d614c80c8308e71987a357a3'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Article: {
      ...
      readonly simpleName: CodecTypes['pg/text@1']['output'] | null;
      readonly description: CodecTypes['pg/text@1']['output'] | null;
      readonly searchTerms: CodecTypes['pg/text@1']['output'] | null;
    };
    readonly ArticleCategory: {
      readonly articlePzn: CodecTypes['pg/text@1']['output'];
      readonly categoryId: CodecTypes['pg/text@1']['output'];
    };
    readonly ArticleIndication: {
      readonly articlePzn: CodecTypes['pg/text@1']['output'];
      readonly indicationName: CodecTypes['pg/text@1']['output'];
    };
    readonly Category: {
    ...
    readonly Indications: {
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly searchTerms: CodecTypes['pg/text@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Article: {
      ...
      readonly simpleName: CodecTypes['pg/text@1']['input'] | null;
      readonly description: CodecTypes['pg/text@1']['input'] | null;
      readonly searchTerms: CodecTypes['pg/text@1']['input'] | null;
    };
    readonly ArticleCategory: {
    ...
    readonly ArticleIndication: {
      readonly articlePzn: CodecTypes['pg/text@1']['input'];
      readonly indicationName: CodecTypes['pg/text@1']['input'];
    };
    readonly Category: {
    ...
    readonly Indications: {
      readonly name: CodecTypes['pg/text@1']['input'];
      readonly searchTerms: CodecTypes['pg/text@1']['input'];
    };
  };
};
          ...
          readonly table: {
            ...
            readonly articleIndication: {
              columns: {
                ...
                readonly indicationName: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                };
              };
              primaryKey: { readonly columns: readonly ['articlePzn', 'indicationName'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'articleIndication_articlePzn_idx_6862e36c';
                  readonly prefix: 'articleIndication_articlePzn_idx';
                  readonly columns: readonly ['articlePzn'];
                  readonly unique: false;
                },
                {
                  readonly name: 'articleIndication_indicationName_idx_1c5c28b5';
                  readonly prefix: 'articleIndication_indicationName_idx';
                  readonly columns: readonly ['indicationName'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'articleIndication';
                    readonly columns: readonly ['articlePzn'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                ...
                },
                {
                  ...
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'indications';
...
> & {
  ...
  readonly roots: {
    ...
    readonly articleIndication: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ArticleIndication';
    };
  };
  readonly domain: {
    readonly namespaces: {
          ...
          readonly Article: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly simpleName: { readonly column: 'simpleName' };
                readonly description: { readonly column: 'description' };
                readonly searchTerms: { readonly column: 'searchTerms' };
              };
            };
          };
          readonly ArticleCategory: {
          ...
          readonly ArticleIndication: {
            ...
            readonly relations: {
              ...
              readonly indication: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['indicationName'];
                  readonly targetFields: readonly ['name'];
                };
              };
            };
            readonly storage: {
              readonly table: 'articleIndication';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly articlePzn: { readonly column: 'articlePzn' };
                readonly indicationName: { readonly column: 'indicationName' };
              };
            };
          };
          readonly Category: {
            ...
            readonly relations: {
              readonly articleIndications: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['indicationName'];
                };
              };
            };
            readonly storage: {
              readonly table: 'indications';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly name: { readonly column: 'name' };
                readonly searchTerms: { readonly column: 'searchTerms' };
