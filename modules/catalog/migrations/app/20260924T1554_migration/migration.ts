...
import type { Contract as End } from '../../snapshots/734b7f1183c5f4e551da8022a39843d19ca5c641d614c80c8308e71987a357a3/contract';
import endContract from '../../snapshots/734b7f1183c5f4e551da8022a39843d19ca5c641d614c80c8308e71987a357a3/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  col,
    ...
    return [
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['indicationName'],
          references: { schema: 'public', table: 'indications', columns: ['name'] },
        },
      }),
      this.addForeignKey({
        schema: 'public',
