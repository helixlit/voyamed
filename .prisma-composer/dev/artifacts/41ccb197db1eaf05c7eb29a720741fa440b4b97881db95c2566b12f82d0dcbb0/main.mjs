// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/nextjs.mjs
var nextjsBuild = (opts) => ({
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/casts-DpaahrlC-C5XMnP9S.mjs
function blindCast(input2) {
  return input2;
}

// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/graph-BfKAg2Ap-LY3OAuK2.mjs
...
function provisionNeed(brand2, payload) {
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/secret-DoWGmN7m-DO5Brq1Y.mjs
...
function isSecretString(value2) {
  return typeof value2 === "object" && value2 !== null && blindCast(value2)[SECRET_BOX] === true;
}

// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/dist-CR0-3j9o.mjs
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/service-rpc.mjs
var RETRY = {
  initialDelayMs: 250,
  multiplier: 2,
  maxDelayMs: 5e3,
...
function makeClient(contract2, url2, opts) {
  const send = opts?.fetch ?? fetch;
  const baseHeaders = { "content-type": "application/json" };
  if (opts?.serviceKey !== void 0) baseHeaders["Authorization"] = `Bearer ${opts.serviceKey}`;
  const client = {};
  for (const method of Object.keys(contract2.__cmp)) client[method] = async (input2) => {
    const idempotencyKey = crypto.randomUUID();
    const body = JSON.stringify(input2);
    return callWithRetry(send, () => new Request(methodUrl(url2, method), {
      method: "POST",
      headers: {
        ...baseHeaders,
...
function rpc(arg) {
  ...
  return dependency({
    ...
    connection: {
      ...
      hydrate: ({ url: url2, serviceKey }) => makeClient(arg, url2, { serviceKey })
    },
    required: arg
  });
}
function isRpcContract(value2) {
  return typeof value2 === "object" && value2 !== null && "kind" in value2 && value2.kind === "rpc" && "__cmp" in value2 && "satisfies" in value2;
}

// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.112__@effect+_794bd67db606123e113d4edfc84db93b/node_modules/@prisma/composer/dist/casts-DpaahrlC-C5XMnP9S.mjs
function blindCast2(input2) {
  return input2;
}

// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.112__@effect+_794bd67db606123e113d4edfc84db93b/node_modules/@prisma/composer/dist/graph-BfKAg2Ap-LY3OAuK2.mjs
var NODE2 = /* @__PURE__ */ Symbol.for("prisma:node");
var SECRET_NEED2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:secret-need"));
var SECRET_SOURCE2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:secret-source"));
var PROVISION_NEED2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:provision-need"));
var PARAM_SOURCE2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:param-source"));
var PARAM_NEED2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:param-need"));
function requireType2(type2, factory) {
  if (typeof type2 !== "string" || type2.length === 0) throw new Error(`${factory}() requires a non-empty node type.`);
}
function requireName2(name, factory) {
  if (typeof name !== "string" || name.length === 0) throw new Error(`${factory}() requires a non-empty name.`);
}
function requireExtension2(extension, factory) {
  if (typeof extension !== "string" || extension.length === 0) throw new Error(`${factory}() requires a non-empty extension (the authoring extension's package name).`);
}
function isConfigKeySegment2(name) {
  return /^[A-Za-z0-9]+$/.test(name);
}
function requireConfigKeySegmentName2(name, kind, factory) {
  if (!isConfigKeySegment2(name)) throw new Error(`${factory}() ${kind} name "${name}" must contain only ASCII letters and digits ([A-Za-z0-9]) \u2014 declared names derive deterministic config keys, uppercased and joined with "_" (an input "db"'s param "url" becomes config key "DB_URL"), so an underscore inside a name collides with that separator and any other character has no place in a config key. "${name}" would put "${name.toUpperCase()}" inside the derived key.`);
}
...
function requireConfigKeySegmentNames2(names, kind, factory) {
  for (const name of names) requireConfigKeySegmentName2(name, kind, factory);
}
function freezeParams2(params) {
  const frozen = {};
  for (const [name, param2] of Object.entries(params)) frozen[name] = Object.freeze({ ...param2 });
  return Object.freeze(frozen);
}
function frozenShallowCopy(obj) {
  return blindCast2(Object.freeze({ ...obj }));
}
var ResourceNodeBase2 = class {
  [NODE2] = true;
  kind = "resource";
  name;
  extension;
  ...
  provides;
  constructor(def) {
    requireName2(def.name, "resource");
    requireExtension2(def.extension, "resource");
    const provides = def.provides;
    if (typeof provides !== "object" || provides === null || typeof provides.kind !== "string" || provides.kind.length === 0 || typeof provides.satisfies !== "function") throw new Error("resource() requires `provides` \u2014 the Contract this resource offers (a non-empty `kind` plus its `satisfies()`).");
    this.name = def.name;
    this.extension = def.extension;
...
function service(def) {
  requireName2(def.name, "service");
  requireExtension2(def.extension, "service");
  requireType2(def.type, "service");
  requireConfigKeySegmentNames2(Object.keys(def.inputs), "input", "service");
  requireConfigKeySegmentNames2(Object.keys(def.params), "param", "service");
  ...
  return Object.freeze({
    ...
    params: freezeParams2(def.params),
    inputSchema: blindCast2(def.input),
    build: Object.freeze({ ...def.build }),
    expose: def.expose !== void 0 ? frozenShallowCopy(def.expose) : void 0
  });
}

// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.112__@effect+_794bd67db606123e113d4edfc84db93b/node_modules/@prisma/composer/dist/secret-DoWGmN7m-DO5Brq1Y.mjs
var REDACTED2 = "[REDACTED]";
var SECRET_BOX2 = blindCast2(/* @__PURE__ */ Symbol.for("prisma:secret-box"));
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.112__@effect+_794bd67db606123e113d4edfc84db93b/node_modules/@prisma/composer/dist/dist-CR0-3j9o.mjs
function scalarSchema2(name, check) {
  return { "~standard": {
    version: 1,
    vendor: "@prisma/composer",
    validate: (value2) => check(value2) ? { value: value2 } : { issues: [{ message: `expected ${name}, got ${typeof value2}` }] }
...
var stringSchema2 = scalarSchema2("string", (v) => typeof v === "string");
var numberSchema2 = scalarSchema2("number", (v) => typeof v === "number" && Number.isFinite(v));
function withFacets2(schema2, opts) {
  return {
    schema: schema2,
    ...opts.optional !== void 0 ? { optional: opts.optional } : {},
    ...opts.default !== void 0 ? { default: opts.default } : {},
...
function number(opts = {}) {
  return withFacets2(numberSchema2, opts);
}
...
// node_modules/.pnpm/@prisma+composer-prisma-cloud@0.16.0_@prisma+cli-engine@0.2.3_magicast@0.5.4__@prisma+o_67ba4669379f7b82172366e0965a999a/node_modules/@prisma/composer-prisma-cloud/dist/secret-Dgyg1WyG-Dzz95fGI.mjs
var PRISMA_CLOUD_PARAM_SOURCE = blindCast2(/* @__PURE__ */ Symbol.for("prisma:prisma-cloud-param-source"));
var PRISMA_CLOUD_GENERATED_PARAM_SOURCE = blindCast2(/* @__PURE__ */ Symbol.for("prisma:prisma-cloud-generated-param-source"));
var PRISMA_CLOUD_SECRET_SOURCE = blindCast2(/* @__PURE__ */ Symbol.for("prisma:prisma-cloud-secret-source"));
...
var deepClone = (input2) => _clone(input2, /* @__PURE__ */ new Map());
var _clone = (input2, seen) => {
  if (typeof input2 !== "object" || input2 === null)
    return input2;
  if (seen?.has(input2))
    return seen.get(input2);
  const builtinConstructorName = getBuiltinNameOfConstructor(input2.constructor);
  if (builtinConstructorName === "Date")
    return new Date(input2.getTime());
  if (builtinConstructorName && builtinConstructorName !== "Array")
    return input2;
  const cloned = Array.isArray(input2) ? input2.slice() : Object.create(Object.getPrototypeOf(input2));
  const propertyDescriptors = Object.getOwnPropertyDescriptors(input2);
  if (seen) {
    seen.set(input2, cloned);
...
var ArkError = class _ArkError extends CastableBase {
  ...
  constructor({ prefixPath, relativePath, ...input2 }, ctx) {
    super();
    this.input = input2;
    this.ctx = ctx;
    defineProperties(this, input2);
    const data = ctx.data;
    if (input2.code === "union") {
      input2.errors = input2.errors.flatMap((innerError) => {
...
var Traversal = class {
  ...
  error(input2) {
    const errCtx = typeof input2 === "object" ? input2.code ? input2 : { ...input2, code: "predicate" } : { code: "predicate", expected: input2 };
  ...
  queueMorphs(morphs) {
    ...
    if (this.currentBranch)
      this.currentBranch.queuedMorphs.push(input2);
    else
      this.queuedMorphs.push(input2);
  }
  finalize(onFail) {
  ...
  errorFromNodeContext(input2) {
    return this.errorFromContext(input2);
  }
...
var assertDefaultValueAssignability = (node2, value2, key) => {
  ...
  if (out instanceof ArkErrors) {
    ...
    const atPath = out.transform((e) => e.transform((input2) => ({ ...input2, prefixPath: [key] })));
...
var BaseScope = class {
  ...
  createParseContext(input2) {
    const id = input2.id ?? registerNodeId(input2.prefix);
    return nodesByRegisteredId[id] = Object.assign(input2, {
      [arkKind]: "context",
      $: this,
      id,
      phase: "unresolved"
...
// node_modules/.pnpm/@prisma+composer-prisma-cloud@0.16.0_@prisma+cli-engine@0.2.3_magicast@0.5.4__@prisma+o_67ba4669379f7b82172366e0965a999a/node_modules/@prisma/composer-prisma-cloud/dist/serializer-DTCrRl7S-CN0q1ZFB.mjs
function blindCast$1(input2) {
  return input2;
}
var REDACTED3 = "[REDACTED]";
var SECRET_BOX3 = blindCast$1(/* @__PURE__ */ Symbol.for("prisma:secret-box"));
var SecretBox3 = class {
  [SECRET_BOX3] = true;
  #value;
  constructor(value2) {
    this.#value = value2;
...
function paramEntries(node2) {
  const entries = [];
  for (const [input2, value2] of Object.entries(node2.inputs)) {
    if (typeof value2 !== "object" || value2 === null) continue;
    const params = blindCast2(value2).connection.params;
...
function encode(owner, value2) {
  return owner === "service" ? JSON.stringify(value2) : blindCast2(value2);
}
...
function hydrateInputDocument(value2, key) {
  ...
  if (isGeneratedPointer(value2)) {
    ...
    return value2.redacted ? new SecretBox3(generated) : generated;
  }
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.112__@effect+_794bd67db606123e113d4edfc84db93b/node_modules/@prisma/composer/dist/service-rpc.mjs
var RPC_PEER_KEY2 = /* @__PURE__ */ Symbol.for("prisma:rpc/per-binding-key");

// node_modules/.pnpm/@prisma+composer-prisma-cloud@0.16.0_@prisma+cli-engine@0.2.3_magicast@0.5.4__@prisma+o_67ba4669379f7b82172366e0965a999a/node_modules/@prisma/composer-prisma-cloud/dist/provisioned-edges-DKsBi7uK-BmsYKWZI.mjs
...
// node_modules/.pnpm/@prisma+composer-prisma-cloud@0.16.0_@prisma+cli-engine@0.2.3_magicast@0.5.4__@prisma+o_67ba4669379f7b82172366e0965a999a/node_modules/@prisma/composer-prisma-cloud/dist/index.mjs
...
var ComputeService = class {
  ...
  load() {
    if (this.#loadedDeps === void 0) this.#loadedDeps = blindCast2(hydrateSync(this, this.#processConfig()));
    return this.#loadedDeps;
  }
  input() {
    if (this.#loadedInput === void 0) this.#loadedInput = blindCast2(readInput(this, ""));
...
// node_modules/.pnpm/@prisma+composer@0.16.0_@effect+platform-bun@4.0.0-rc.112_effect@4.0.0-rc.111__@effect+_a18adb44b0de8cf3c5a9f13b55d6faa2/node_modules/@prisma/composer/dist/arktype.mjs
...
var NODE3 = /* @__PURE__ */ Symbol.for("prisma:node");
var SECRET_NEED3 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:secret-need"));
var SECRET_SOURCE3 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:secret-source"));
var PROVISION_NEED3 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:provision-need"));
function provisionNeed3(brand2, payload) {
  return blindCast3(Object.freeze({
    [PROVISION_NEED3]: true,
    brand: brand2,
    payload
  }));
}
var PARAM_SOURCE3 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:param-source"));
var PARAM_NEED3 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:param-need"));
function requireType3(type2, factory) {
  if (typeof type2 !== "string" || type2.length === 0) throw new Error(`${factory}() requires a non-empty node type.`);
}
function requireName3(name, factory) {
  if (typeof name !== "string" || name.length === 0) throw new Error(`${factory}() requires a non-empty name.`);
}
function requireExtension3(extension, factory) {
  if (typeof extension !== "string" || extension.length === 0) throw new Error(`${factory}() requires a non-empty extension (the authoring extension's package name).`);
}
function isConfigKeySegment3(name) {
  return /^[A-Za-z0-9]+$/.test(name);
}
function requireConfigKeySegmentName3(name, kind, factory) {
  if (!isConfigKeySegment3(name)) throw new Error(`${factory}() ${kind} name "${name}" must contain only ASCII letters and digits ([A-Za-z0-9]) \u2014 declared names derive deterministic config keys, uppercased and joined with "_" (an input "db"'s param "url" becomes config key "DB_URL"), so an underscore inside a name collides with that separator and any other character has no place in a config key. "${name}" would put "${name.toUpperCase()}" inside the derived key.`);
}
function requireConfigKeySegmentNames3(names, kind, factory) {
  for (const name of names) requireConfigKeySegmentName3(name, kind, factory);
}
function freezeParams3(params) {
  const frozen = {};
  for (const [name, param2] of Object.entries(params)) frozen[name] = Object.freeze({ ...param2 });
  return Object.freeze(frozen);
}
var ResourceNodeBase3 = class {
  [NODE3] = true;
  kind = "resource";
  name;
  extension;
  ...
  provides;
  constructor(def) {
    requireName3(def.name, "resource");
    requireExtension3(def.extension, "resource");
    const provides = def.provides;
    if (typeof provides !== "object" || provides === null || typeof provides.kind !== "string" || provides.kind.length === 0 || typeof provides.satisfies !== "function") throw new Error("resource() requires `provides` \u2014 the Contract this resource offers (a non-empty `kind` plus its `satisfies()`).");
    this.name = def.name;
    this.extension = def.extension;
...
function dependency3(def) {
  requireType3(def.type, "dependency");
  requireConfigKeySegmentNames3(Object.keys(def.connection.params), "param", "dependency");
  const connection = Object.freeze({
    params: freezeParams3(def.connection.params),
    hydrate: def.connection.hydrate
  });
  return Object.freeze({
    [NODE3]: true,
...
var SECRET_BOX4 = blindCast3(/* @__PURE__ */ Symbol.for("prisma:secret-box"));
var SecretBox4 = class {
  [SECRET_BOX4] = true;
  #value;
  constructor(value2) {
    this.#value = value2;
...
function scalarSchema3(name, check) {
  return { "~standard": {
    version: 1,
    vendor: "@prisma/composer",
    validate: (value2) => check(value2) ? { value: value2 } : { issues: [{ message: `expected ${name}, got ${typeof value2}` }] }
...
var stringSchema3 = scalarSchema3("string", (v) => typeof v === "string");
var numberSchema3 = scalarSchema3("number", (v) => typeof v === "number" && Number.isFinite(v));
function withFacets3(schema2, opts) {
  return {
    schema: schema2,
    ...opts.optional !== void 0 ? { optional: opts.optional } : {},
    ...opts.default !== void 0 ? { default: opts.default } : {},
...
function string4(opts = {}) {
  return withFacets3(stringSchema3, opts);
}
...
var IDEMPOTENCY_KEY_HEADER$12 = "Idempotency-Key";
function sleep2(ms) {
  return new Promise((resolve) => setTimeout(resolve, ms));
}
...
async function errorDetail2(res) {
  try {
    const body = await res.json();
    return typeof body === "object" && body !== null && "error" in body ? String(body.error) : void 0;
  } catch {
...
function methodUrl2(base, method) {
  const normalizedBase = base.endsWith("/") ? base : `${base}/`;
  return new URL(`rpc/${method}`, normalizedBase).toString();
}
async function callWithRetry2(send, buildRequest, method) {
  let delay = RETRY2.initialDelayMs;
  let retries = 0;
  for (; ; ) {
    let res;
    try {
      ...
      if (retries >= RETRY2.maxRetries) throw err;
      retries += 1;
      await sleep2(Math.random() * delay);
      delay = Math.min(delay * RETRY2.multiplier, RETRY2.maxDelayMs);
      continue;
    }
    if (res.ok) return res.json();
    if (!isRetryableStatus2(res.status) || retries >= RETRY2.maxRetries) {
      const detail = await errorDetail2(res);
      throw new Error(`RPC call "${method}" failed: ${res.status} ${res.statusText}` + (detail !== void 0 ? ` \u2014 ${detail}` : ""));
    }
    retries += 1;
    await sleep2(Math.random() * delay);
...
function makeClient2(contract2, url2, opts) {
  const send = opts?.fetch ?? fetch;
  const baseHeaders = { "content-type": "application/json" };
  if (opts?.serviceKey !== void 0) baseHeaders["Authorization"] = `Bearer ${opts.serviceKey}`;
  const client = {};
  for (const method of Object.keys(contract2.__cmp)) client[method] = async (input2) => {
    const idempotencyKey = crypto.randomUUID();
    const body = JSON.stringify(input2);
    return callWithRetry2(send, () => new Request(methodUrl2(url2, method), {
      method: "POST",
      headers: {
        ...baseHeaders,
        [IDEMPOTENCY_KEY_HEADER$12]: idempotencyKey
      },
      body
    }), method);
  };
  return blindCast3(client);
}
function contract(fns) {
  const value2 = {
    kind: "rpc",
    __cmp: fns,
    satisfies: (required) => value2 === required
  };
  return Object.freeze(value2);
}
var RPC_PEER_KEY3 = /* @__PURE__ */ Symbol.for("prisma:rpc/per-binding-key");
var perBindingToken2 = () => provisionNeed3(RPC_PEER_KEY3);
function rpc2(arg) {
  if (!isRpcContract2(arg)) return arg;
  return dependency3({
    type: "rpc",
    connection: {
      params: {
        ...
        serviceKey: string4({
          optional: true,
          provision: perBindingToken2()
        })
      },
      hydrate: ({ url: url2, serviceKey }) => makeClient2(arg, url2, { serviceKey })
    },
    required: arg
  });
}
function isRpcContract2(value2) {
  return typeof value2 === "object" && value2 !== null && "kind" in value2 && value2.kind === "rpc" && "__cmp" in value2 && "satisfies" in value2;
}

// modules/catalog/src/contract.ts
var article = type({
  pzn: "string",
  name: "string",
  active: "boolean",
...
var service_default = compute({
  ...
  build: nextjsBuild({ module: import.meta.url, appDir: ".." })
});
export {
