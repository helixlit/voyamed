      ...
      <div className="relative flex flex-col w-full h-full">
        <div className="h-[clamp(20rem,40vw,50rem)] relative text-background gap-5 z-50 flex flex-col items-center justify-center w-fit m-auto text-[clamp(1rem,8vw,5rem)] pb-10 dark:text-foreground">
          <div className=" z-50 w-full text-center [text-shadow:0_1px_10px_rgba(0,0,0,0.3)] overflow-visible">
            <h1 key={slides[index].title1} className="text-fade-in ">
              {slides[index].title1}
            </h1>
            <h1 key={slides[index].title2} className="text-fade-in">
              {slides[index].title2}
            </h1>
          </div>
          <Link href="/globe" className=" text-background/90 dark:text-background/90 shadow-[0_0_20px_5px_rgba(0,0,0,0.6)] border-3 border-background/10 hover:border-to-background/80 text-center bg-highlight/30 rounded-4xl p-3 backdrop-blur-[3px] transition-all duration-400 hover:bg-highlight/80 text-[clamp(1rem,6vw,4rem)]">
